...
export function Button({ variant = 'default', size = 'md', loading, className, disabled, children, ...props }: ButtonProps) {
  return (
    <button
      ...
      className={cn(
        'inline-flex items-center justify-center gap-1.5 rounded-md font-medium transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#2563eb] disabled:pointer-events-none disabled:opacity-50',
