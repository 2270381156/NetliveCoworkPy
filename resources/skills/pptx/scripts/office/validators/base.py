...
except ModuleNotFoundError:  # defusedxml is optional — fall back to the stdlib parser (local, trusted XML only)
    import types as _types
    import xml.dom.minidom as _minidom
    defusedxml = _types.ModuleType("defusedxml")
    defusedxml.minidom = _minidom
import lxml.etree
...
class BaseSchemaValidator:
    ...
    IGNORED_VALIDATION_ERRORS = [
        "hyphenationZone",
        "purl.org/dc/terms",
        "}zoom'",  # python-docx's default template emits <w:zoom w:val="bestFit"/>; the XSD wrongly demands w:percent
    ]
