...
(formula recalculation, rendering to PDF/images). The core workflow is pure
Python and does NOT need this. If soffice is not installed, those optional
operations are simply unavailable; nothing else breaks.

Usage:
    from office.soffice import run_soffice, get_soffice_env
    result = run_soffice(["--headless", "--convert-to", "pdf", "input.xlsx"])
"""
