...
To double-check *where your planned boxes land* (before or after filling), overlay them on a page image:
`python scripts/create_validation_image.py <page_number> fields.json <input.pdf> <overlay.png>`
This draws each field's label/entry box so you can confirm placement visually.
